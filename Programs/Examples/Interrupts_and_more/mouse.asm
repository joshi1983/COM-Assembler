; program sets the screen to use graphics and the mouse
; copyright 2003 Dreq
; all rights reserved
...
mov dx, offset click		;label to jump to on mouse click (im not sure about how to type that part ;)
...
mov ah, 1		;func 0h (set video mode)
mov al, 21h		;mode 13h (320x200x256)
int 10h			;ms-dos graphics
